...
%GCC_BIN%\riscv64-unknown-elf-gcc.exe -march=rv32i -mabi=ilp32 -Os -Wall -ffreestanding -nostdlib -T prototip3_linker.ld -nostartfiles -Wl,--no-relax crt0.S main.c -o firmware.elf
