...
## Kamera PCLK saat kisiti (25 MHz). Onceden kisit yoktu -> yakalama
## mantigi (capture + framebuffer yazma) tamamen kisitsiz yerlestiriliyordu
## ve ornekleme hatalari ekranda karincalanma uretiyordu.
create_clock -period 40.000 -name cam_pclk [get_ports ov7670_pclk]

## cam_pclk ile dahili saatler (MMCM 50/25 MHz) arasindaki gecisler
## yapisal olarak guvenli (cift saatli BRAM + 2FF senkronizer) -> async grup.
